...
<body background="images\img5.jpg">
  ...
  <li><a  class="active" href="Flighttckt.jsp">Bus Ticket</a></li>
  <li><a  href="Bustckt.jsp">Bus Ticket</a></li>
...
<div class="w3-half w3-container">  
  <div class="w3-card-4" style="width:100%">
   ...
   try{
   	...
   	ResultSet rs=stmt.executeQuery("select * from bus where frm='"+from+"' && dest='"+to+"'");
